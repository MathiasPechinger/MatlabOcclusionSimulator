function [] = analyseFlows(AVpercentage, FOVrange, usePlot,aimsunDataName,osmDataName,MapX,MapY,bPlotParkedVeh,bVisualizeDebug)
...
%         display("error2 "+me.message)
    ...
    if bCreateGif
        % Capture the frame
        frame_getter = getframe(gcf);
        img = frame2im(frame_getter);
