...
The algorithm runs quite slow. Do not expect realtime capabilities. The "ray-tracing" approach in this repositioy is utilized using basic mathematical equations wihtout any acceleration techniques.
